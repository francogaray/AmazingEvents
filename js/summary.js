...
function audiencia(){
  ...
  var fila = document.querySelector("#porcentaje")
...
function ingreso(){
  ...
  var fila = document.querySelector("#ingresos")
...
function masAudiencia(){
  ...
  var imprimir = document.querySelector("#mayor-audiencia");
...
function menosAudiencia(){
  ...
  var imprimir = document.querySelector("#menor-audiencia");
...
function masCapacidad(){
  ...
  pasados.forEach(evento=>{
    if(evento.capacity > capacidadActual){
      audienciaActual = evento.capacity;
